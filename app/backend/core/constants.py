...
BATCH_QUOTES_CACHE_TTL_SEC = 120
...
ERROR_SERVICE_LOGIN_EXISTS = "Логин сервиса уже занят"
...
ERROR_TINKOFF_TOKEN_INVALID = "Токен Tinkoff недействителен или отозван. Обновите его в настройках."
