...
const ObligationsPageMobile = () => {
  ...
  const handleCreateBlock = async () => {
    ...
    try {
      ...
      toast.success('Кредит создан — график платежей заполнен');
      await loadData();
  ...
  return (
    <div className="px-4 py-4 space-y-4">
      ...
      {/* Summary Cards */}
      <div className="grid grid-cols-2 gap-3" data-tour="obligations-summary">
      ...
      {/* Blocks List */}
      <div className="space-y-3" data-tour="obligations-blocks">
        {loading ? (
          ...
          <div className="bg-white dark:bg-gray-800 w-full rounded-t-xl p-4 pb-safe-bottom max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              ...
              {!editingBlock && newBlock.total > 0 && newBlock.monthly > 0 && (
                <p className="text-xs text-gray-600 dark:text-gray-400 bg-blue-50 dark:bg-blue-900/20 rounded-lg p-3">
                  После создания автоматически заполним график из{' '}
